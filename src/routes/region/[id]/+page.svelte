		...
		<section>
			...
			<ul>
				...
				{#if data.region.country}
					<li>Current Country: {data.region.country.name} ({data.region.country.code})</li>
				{/if}
				{#if data.region.initialCountry}
					<li>Initial Country: {data.region.initialCountry.name} ({data.region.initialCountry.code})</li>
				{/if}
			</ul>
		</section>
			...
			{:else}
				<ul>
					{#each data.region.neighbors as neighbor (neighbor.country.id)}
						<li>{neighbor.country.name} ({neighbor.country.code})</li>
					{/each}
				</ul>
			{/if}
		</section>
